...
## Project Structure
    ...
    ├── tst_branch_deploy_1_2  # Django project configurations
...
1. Clone this repo and `cd tst_branch_deploy_1_2`
...
2. Clone this repo and `cd tst_branch_deploy_1_2`
